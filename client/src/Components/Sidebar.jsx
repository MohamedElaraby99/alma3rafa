      ...
      <div className="drawer-side z-50">
        ...
        <div className="min-h-full w-64 bg-white dark:bg-gray-900 text-base-content p-3 relative z-60" dir="rtl">
          ...
          <ul className="menu space-y-1">
            <li>
              <Link to="/" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors text-right py-2" onClick={closeSidebar}>
            ...
            {(role === "ADMIN" || role === "SUPER_ADMIN") && (
              <li>
                <Link to="/admin/dashboard" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors text-right py-2" onClick={closeSidebar}>
            ...
            {/* Courses Section */}
            <li>
              <Link to="/courses" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors text-right py-2" onClick={closeSidebar}>
            ...
            {isLoggedIn && !["ADMIN", "SUPER_ADMIN"].includes(role) && (
              <li>
                <Link to="/wallet" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors text-right py-2" onClick={closeSidebar}>
            ...
            <li>
              <Link to="/instructors" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors py-2" onClick={closeSidebar}>
            ...
            {!["ADMIN", "SUPER_ADMIN"].includes(role) && (
              <>
                <li>
                  <Link to="/blogs" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors py-2" onClick={closeSidebar}>
                ...
                <li>
                  <Link to="/qa" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors py-2" onClick={closeSidebar}>
                ...
                <li>
                  <Link to="/whatsapp-services" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors py-2" onClick={closeSidebar}>
                ...
                <li>
                  <Link to="/contact" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors py-2" onClick={closeSidebar}>
                ...
                <li>
                  <Link to="/about" className="flex gap-3 items-center text-gray-700 dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors py-2" onClick={closeSidebar}>
                    <FaInfoCircle size={16} className="text-gray-500 dark:text-slate-100" />
                    عنا
                  </Link>
                </li>
