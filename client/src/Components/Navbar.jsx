      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-0.5">
          ...
          {/* Modern Logo */}
            ...
            <div className="relative">
              {/* Logo Image */}
               ...
               />
               <h3 className="text-lg font-bold text-green-600 dark:text-green-300">المعرفة</h3>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="relative w-16 h-8 rounded-full bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 transition-all duration-300 shadow-lg hover:shadow-xl border border-green-300 dark:border-green-600 overflow-hidden"
            >
              {/* Sun Icon (Left side) */}
              ...
              {/* Toggle Thumb */}
              <div className={`absolute top-1 w-6 h-6 bg-white rounded-full border-2 border-green-400 transition-all duration-300 transform ${darkMode ? 'translate-x-8' : 'translate-x-1'}`}>
                {darkMode ? (
                  <FaMoon className="w-3 h-3 text-green-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                ) : (
                  <FaSun className="w-3 h-3 text-green-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                )}
              </div>
            </button>
            ...
            {!user?.fullName && (
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl text-sm font-semibold text-white bg-gradient-to-r from-green-600 via-green-500 to-green-600 hover:from-green-700 hover:via-green-600 hover:to-green-700 shadow-lg hover:shadow-xl transition-all duration-300 border border-green-400/40"
              >
            ...
            {!user?.fullName && (
              <Link
                to="/login"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl text-sm font-semibold border-2 border-green-500 text-green-600 dark:text-green-400 hover:bg-gradient-to-r hover:from-green-500 hover:via-green-600 hover:to-green-500 hover:text-white transition-all duration-300 shadow-md hover:shadow-xl"
              >
                ...
                <Link
                  ...
                  className={`flex items-center space-x-4 px-6 py-4 mx-4 rounded-2xl font-medium transition-all duration-300 mobile-menu-item ${
                    location.pathname === item.path
                      ? "text-green-600 dark:text-green-400 bg-gradient-to-r from-green-50 to-green-50 dark:from-green-900/20 dark:to-green-900/20 shadow-lg"
                      : "text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 hover:bg-gradient-to-r hover:from-gray-50 hover:to-green-50 dark:hover:from-gray-800 dark:hover:to-green-900/20"
                  }`}
                >
                  <div className={`p-3 rounded-xl shadow-lg ${
                    location.pathname === item.path
                      ? "bg-gradient-to-r from-green-100 to-green-100 dark:from-green-900/30 dark:to-green-900/30"
            ...
            {user && (
              <>
                <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-6">
                  <div className="px-6 py-4 mx-4 bg-gradient-to-r from-green-50 to-green-50 dark:from-green-900/20 dark:to-green-900/20 rounded-2xl shadow-lg">
                    <div className="flex items-center space-x-4">
                      <div className="w-14 h-14 bg-gradient-to-r from-green-600 to-green-600 rounded-2xl flex items-center justify-center shadow-xl">
            ...
            {!user && (
              <div className="space-y-4 px-6">
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    ابدأ رحلة التعلم مع منصة  المعرفة
                  </p>
                </div>
                
                <Link
                  to="/login"
                  className="flex items-center justify-center gap-2 w-full px-4 py-2 text-center bg-gradient-to-r from-green-500 via-green-600 to-green-500 hover:from-green-600 hover:via-green-700 hover:to-green-600 text-white rounded-xl font-semibold text-sm transition-all duration-300 transform hover:scale-105 mobile-menu-item shadow-lg hover:shadow-xl border-2 border-green-400/50"
                >
                  <FaUser className="w-4 h-4" />
                  تسجيل الدخول
                </Link>
                <Link
                  to="/signup"
                  className="flex items-center justify-center gap-2 w-full px-4 py-2 text-center border-2 border-green-500 text-green-600 dark:text-green-400 hover:bg-gradient-to-r hover:from-green-500 hover:via-green-600 hover:to-green-500 hover:text-white rounded-xl font-semibold text-sm transition-all duration-300 mobile-menu-item shadow-lg hover:shadow-xl"
                >
                  <FaPlus className="w-4 h-4" />
                  إنشاء حساب جديد
                </Link>
