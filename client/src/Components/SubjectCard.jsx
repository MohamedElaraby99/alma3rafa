      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {subject.featured && (
          <div className="absolute top-2 right-2">
            <span className="bg-green-500 text-white px-2 py-1 rounded-full text-xs font-medium">مميز</span>
          </div>
        )}
        {/* Play Button Overlay */}
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`px-3 py-1 rounded text-sm transition-colors ${
                  subject.featured ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-gray-600 hover:bg-gray-700 text-white'
                }`}
              >
