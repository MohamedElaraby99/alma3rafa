                                ...
                                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-6">
                                    ...
                                    <ul className="space-y-2 text-green-800 dark:text-green-200">
                                        <li className="flex items-start">
                                            ...
                                            تواصل معنا على واتساب: <strong> 01090562548</strong> للحصول على كود شحن
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-green-600 dark:text-green-400 ml-2">•</span>
                                            أو ادفع عبر فودافون كاش: <strong>01090562548</strong>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-green-600 dark:text-green-400 ml-2">•</span>
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded border border-green-200 dark:border-green-600">
                                                ...
                                                <button
                                                    onClick={() => {
                                                        ...
                                                        window.open(`https://wa.me/201090562548?text=${encodeURIComponent(message)}`, '_blank');
                                                    }}
