...
export default function Contact() {
  ...
  const contactInfo = {
    phone: "01090562548",
    whatsapp: "+201090562548",
    vodafoneCash: "01090562548",
  ...
  const socialMedia = [
    { name: "Facebook", icon: FaFacebook, url: "https://www.facebook.com/share/171jcB9F3q/", color: "hover:text-green-600" },
    { name: "Instagram", icon: FaInstagram, url: "https://www.instagram.com/ahmed_esmill_elshafei?utm_source=qr&igsh=MThtYmo0OWZhc2Nnbg==", color: "hover:text-green-600" },
    { name: "snap", icon: FaSnapchat, url: "https://www.snapchat.com/add/ahmed_elsha7898?share_id=CMgALU6TDkc&locale=ar-EG", color: "hover:text-green-600" },
    { name: "Tiktok", icon: FaTiktok, url: "https://www.tiktok.com/@swiftkey5924?_t=ZS-8zGAGXL4oTf&_r=1", color: "hover:text-green-600" },
