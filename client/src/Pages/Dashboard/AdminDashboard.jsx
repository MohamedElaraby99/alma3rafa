        ...
        <section className="relative py-16 px-4 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto">
            ...
            <div className={`text-center mb-12 transition-all duration-1000 ease-out ${
              ...
              <h1 className={`text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-green-600 to-indigo-600 dark:from-green-400 dark:via-green-400 dark:to-indigo-400 mb-4 transition-all duration-700 delay-200 ${
                heroLoaded 
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl p-4 lg:p-6 mb-8 lg:mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                ...
                {/* إدارة الأجهزة */}
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-4 lg:p-6 text-white hover:from-green-600 hover:to-green-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/device-management")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaServer className="text-2xl lg:text-3xl text-green-200" />
                  ...
                  <p className="text-green-100 text-sm lg:text-base opacity-90">مراقبة وإدارة الأجهزة المتصلة</p>
                  <div className="mt-4 flex items-center justify-between">
                ...
                {/* إدارة المراحل */}
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-4 lg:p-6 text-white hover:from-green-600 hover:to-green-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/stages")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaGraduationCap className="text-2xl lg:text-3xl text-green-200" />
                    <div className="w-3 h-3 bg-green-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">إدارة المراحل</h4>
                  <p className="text-green-100 text-sm lg:text-base opacity-90">إدارة المراحل الدراسية</p>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-green-200">إدارة كاملة</span>
                    <FaArrowUp className="text-green-200 transform rotate-45" />
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl p-4 lg:p-6 mb-8 lg:mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-4 lg:p-6 text-white hover:from-green-600 hover:to-green-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/course-access-codes")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaTicketAlt className="text-2xl lg:text-3xl text-green-200" />
                    <div className="w-3 h-3 bg-green-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">أكواد فتح الكورس</h4>
                  <p className="text-green-100 text-sm lg:text-base opacity-90">توليد أكواد وصول مؤقتة لكورس محدد</p>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-green-200">توليد وإدارة</span>
                    <FaArrowUp className="text-green-200 transform rotate-45" />
                  </div>
                </div>
