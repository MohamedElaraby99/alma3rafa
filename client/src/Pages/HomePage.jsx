...
export default function HomePage() {
  ...
  const handleAPKDownload = () => {
    ...
    link.href = '/downloads/alma3rafa.apk'; // Update this path to your APK file location
    link.download = 'alma3rafa.apk';
    link.target = '_blank';
    
    // Fallback for mobile browsers
    if (navigator.userAgent.toLowerCase().indexOf('android') > -1) {
      // For Android devices, open the download directly
      window.open('/downloads/alma3rafa.apk', '_blank');
    } else {
  ...
  const stats = [
    ...
    { icon: FaStar, number: "4.9", label: "متوسط التقييم", color: "text-green-600" },
    { icon: FaAward, number: "50+", label: "مدرس مدرس", color: "text-green-600" }
  ];
    ...
    <Layout>
      ...
      style={{ transitionDelay: '400ms' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* green Strip */}
          <div className="w-full h-2 bg-green-400 mb-8"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      <Link
                        ...
                        className="flex-1 bg-gradient-to-r from-green-500 via-green-600 to-green-500 hover:from-green-600 hover:via-green-700 hover:to-green-600 text-white text-center py-2 px-4 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                      >
                        <FaEye />
                      ...
                      <Link
                        to="/courses"
                        className="px-4 py-2 border border-green-500 text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg transition-colors flex items-center justify-center"
                      >
                        <FaArrowRight />
                      </Link>
                    </div>
          ...
          {featuredCourses && featuredCourses.length > 0 && (
            <div className="text-center mt-12">
              <Link
                to="/courses"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-green-500 via-green-600 to-green-500 hover:from-green-600 hover:via-green-700 hover:to-green-600 text-white font-semibold rounded-xl text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        to={`/blog/${blog._id}`}
                        className="text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 font-medium flex items-center gap-1 group"
                      >
                        اقرأ المزيد
      ...
      {/* CTA Section */}
      <section className={`py-20 bg-gradient-to-r from-green-500 via-green-600 to-green-500 transition-all duration-700 ease-out ${
        heroLoaded 
          ? 'opacity-100 translate-y-0' 
          : 'opacity-0 translate-y-8'
      }`}
      style={{ transitionDelay: '3600ms' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          style={{ transitionDelay: '4000ms' }}>
            <Link to="/signup">
              <button className="px-8 py-4 bg-gradient-to-r from-green-500 via-green-600 to-green-500 hover:from-green-600 hover:via-green-700 hover:to-green-600 text-white font-semibold rounded-full text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                ابدأ مجاناً
              </button>
            </Link>
            
            <Link to="/qa">
              <button className="px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-full text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-2">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 via-green-50 to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" dir="rtl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
                  حمّل التطبيق
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-600">
                    وتعلم في أي مكان
                  </span>
                </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center">
                    <FaPlay className="w-4 h-4 text-green-600 dark:text-green-400" />
                  </div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center">
                    <FaBookOpen className="w-4 h-4 text-green-600 dark:text-green-400" />
                  </div>
              ...
              <div className="flex items-center space-x-8 pt-6 text-sm text-gray-600 dark:text-gray-400">
                <div className="flex items-center space-x-2">
                  <FaStar className="w-4 h-4 text-green-500 ml-1" />
                  <span>4.8 تقييم</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <FaUsers className="w-4 h-4 text-green-500 ml-1" />
                  <span>مجاني 100%</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative">
                  ...
                  <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
                    ...
                    <div className="p-6 space-y-6">
                      ...
                      <div className="flex items-center space-x-4" dir="rtl">
                        ...
                        <div>
                          <h3 className="font-bold text-lg text-gray-900">تطبيق المعرفة</h3>
                      ...
                      <div className="space-y-4">
                        <div className="bg-gradient-to-r from-green-50 to-green-50 rounded-xl p-4">
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-green-600 font-medium">30% مكتمل</span>
                        ...
                        <div className="bg-gradient-to-r from-green-50 to-green-50 rounded-xl p-4">
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">شائع</span>
                          </div>
                ...
                {/* Floating Elements */}
                <div className="absolute -top-6 -right-6 w-20 h-20 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                  <FaDownload className="text-white text-2xl" />
                </div>
                
                <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
      ...
      {/* Static FAQ Section */}
      <section className="py-16 px-4 lg:px-20 bg-gradient-to-br from-gray-50 to-green-50 dark:from-gray-900 dark:to-gray-800" dir="rtl">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div>
                  ...
                  <a href="tel:01090562548" className="text-green-600 dark:text-green-400 hover:underline">
                    01090562548
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div>
                  ...
                  <a href="https://wa.me/+201090562548" className="text-green-600 dark:text-green-400 hover:underline">
                  +201090562548
                  </a>
                </div>
              </div>
            ...
            <div className="mt-12 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 max-w-md mx-auto">
                <a
                  href="https://www.facebook.com/share/171jcB9F3q/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:text-green-600 hover:scale-105"
                  title="Facebook"
                >
                ...
                <a
                  href="https://www.instagram.com/ahmed_esmill_elshafei?utm_source=qr&igsh=MThtYmo0OWZhc2Nnbg=="
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:text-green-600 hover:scale-105"
                  title="Instagram"
                ...
                <a
                  href="https://www.tiktok.com/@swiftkey5924?_t=ZS-8zGAGXL4oTf&_r=1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:text-green-600 hover:scale-105"
                  title="TikTok"
                ...
                <a
                  href="https://www.snapchat.com/add/ahmed_elsha7898?share_id=CMgALU6TDkc&locale=ar-EG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:text-green-600 hover:scale-105"
                  title="Snapchat"
            ...
            {/* Additional Info */}
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-green-50 to-green-50 dark:from-green-900/20 dark:to-green-900/20 rounded-2xl p-8">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 p-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 group"
