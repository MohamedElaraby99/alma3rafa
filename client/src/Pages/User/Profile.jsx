      ...
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
        ...
        >
          <div className="flex justify-center items-center">
            <h1 className="text-center absolute left-6 md:top-auto top-5 text-violet-500 dark:text-green-500 md:text-4xl text-3xl font-bold font-inter after:content-[' ']  after:absolute after:-bottom-3.5 after:left-0 after:h-1.5 after:w-[60%] after:rounded-full after:bg-green-400 dark:after:bg-green-600">
              الملف الشخصي
            </h1>
            {/* avatar */}
            <div
