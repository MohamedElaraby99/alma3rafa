           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
             <div className={`border rounded-xl p-4 ${
               courseAccessState?.hasAccess 
                 ? 'bg-gradient-to-r from-green-50 to-green-50 dark:from-green-900/20 dark:to-green-900/20 border-green-200 dark:border-green-700'
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg mt-2">
                  ...
                  <span className="font-semibold text-green-600">{walletBalance} جنيه</span>
                </div>
              </div>
